...
//		console.log(data);
	...
	factory.prepareURLs = function() {
		...
		factory.connectionsUrl='http://REPLACEIP:REPLACEPORT/'+urlprefix+'api/jolokia/read/org.apache.activemq:type=Broker,brokerName=REPLACEBROKERNAME,connectionViewType=clientId,connectionName=*';	
